...
const WelcomeMessage = () => {
  ...
  const messageLines = [
    ...
    <div key="poem" style={{ marginTop: '0' }}>
      ...
      <div className="poem-line">where every tale waits like iron in the fire.</div>
  ...
  return (
    <div 
      ref={welcomeRef}
      className={`welcome-message ${isVisible ? 'visible' : ''} ${isClicked ? 'clicked' : ''}`}
    >
      <div className="welcome-content">
        <h1 className="welcome-text" onClick={handleTextClick}>
          Welcome, <span className="adventurer-text">Adventurer</span>
        </h1>
        <button 
      ...
      <div className="poem-container">
        ...
        <div className="poem-line">Or, if you already carry one,</div>
        <div className="poem-line" style={{ marginTop: '1.5rem' }}>
          <span className="highlight-text" style={{fontFamily: 'Cormorant Garamond'}}>
            Tell me friend, which fire shall I set upon the anvil for you?
          </span>
        </div>
      </div>
        <button 
